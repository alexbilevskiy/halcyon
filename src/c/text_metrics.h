...
// Choose our fonts based on platform
  ...
  #define FONT_SECONDARY_TEXT_STANDARD         FONT_KEY_GOTHIC_24
  #define FONT_SECONDARY_TEXT_STANDARD_HEIGHT  METRIC_GOTHIC_24_HEIGHT
  #define FONT_SECONDARY_TEXT_STANDARD_OFFSET  METRIC_GOTHIC_24_OFFSET
  ...
  #define FONT_SECONDARY_TEXT_LARGE         FONT_KEY_GOTHIC_28
  #define FONT_SECONDARY_TEXT_LARGE_HEIGHT  METRIC_GOTHIC_28_HEIGHT
  #define FONT_SECONDARY_TEXT_LARGE_OFFSET  METRIC_GOTHIC_28_OFFSET
  ...
  #define FONT_SECONDARY_TEXT_STANDARD         FONT_KEY_GOTHIC_18
  #define FONT_SECONDARY_TEXT_STANDARD_HEIGHT  METRIC_GOTHIC_18_HEIGHT
  #define FONT_SECONDARY_TEXT_STANDARD_OFFSET  METRIC_GOTHIC_18_OFFSET
  ...
  #define FONT_SECONDARY_TEXT_LARGE         FONT_KEY_GOTHIC_24
  #define FONT_SECONDARY_TEXT_LARGE_HEIGHT  METRIC_GOTHIC_24_HEIGHT
  #define FONT_SECONDARY_TEXT_LARGE_OFFSET  METRIC_GOTHIC_24_OFFSET
  ...
  #define FONT_SECONDARY_TEXT_STANDARD         FONT_KEY_GOTHIC_18_BOLD
  #define FONT_SECONDARY_TEXT_STANDARD_HEIGHT  METRIC_GOTHIC_18_BOLD_HEIGHT
  #define FONT_SECONDARY_TEXT_STANDARD_OFFSET  METRIC_GOTHIC_18_BOLD_OFFSET
  ...
  #define FONT_SECONDARY_TEXT_LARGE         FONT_KEY_GOTHIC_24_BOLD
  #define FONT_SECONDARY_TEXT_LARGE_HEIGHT  METRIC_GOTHIC_24_BOLD_HEIGHT
  #define FONT_SECONDARY_TEXT_LARGE_OFFSET  METRIC_GOTHIC_24_BOLD_OFFSET
